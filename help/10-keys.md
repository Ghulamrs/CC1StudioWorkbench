...
**`ed1gui` differs on ten keys deliberately** — `Ctrl+PageDown` and
...
```
ed1 [file] [--project dir] [--toolchain auto|cc1|msvc|shc|c++]
...
msbuild winforms\ed1gui.vcxproj /p:Configuration=Release /p:Platform=x64
```
